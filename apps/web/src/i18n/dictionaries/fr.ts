...
export const fr: Dictionary = {
  ...
  features: {
    ...
    prayer: {
      ...
      desc: 'Partagez vos besoins de prière et intercédez pour les autres dans un environnement communautaire bienveillant.',
    },
    testimony: {
      title: 'Partager des Témoignages',
      desc: "Célébrez l'œuvre de Dieu dans votre vie et inspirez les autres avec des histoires de foi.",
    },
    groups: {
      title: 'Petits Groupes',
      desc: "Rejoignez ou créez des petits groupes pour l'étude biblique, la communion et la responsabilité.",
    },
    resources: {
      title: "Ressources d'Étude",
      desc: 'Accédez à des sermons, des dévotions et des ressources bibliques pour approfondir votre compréhension.',
    },
    moments: {
      title: 'Moments Quotidiens',
      desc: 'Capturez et partagez des moments significatifs de foi tout au long de votre journée.',
    },
    safe: {
