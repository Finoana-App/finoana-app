      ...
      <div className="container-docs">
        <div className="max-w-3xl mb-16 md:mb-24">
          ...
          <motion.p
            ...
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            className="feature-header mt-4 text-lg text-muted-foreground"
          >
            {t("features.subtitle")}
          </motion.p>
        </div>
        <div className="features-grid grid md:grid-cols-2 lg:grid-cols-3 gap-px bg-border rounded-lg overflow-hidden">
          {features.map((feature) => (
            <motion.div
              key={`${feature.title}-${language}`}
              className="feature-item bg-background p-8 md:p-10 group cursor-default"
            ...
            >
              ...
              <h3 className="text-xl font-semibold mt-4 mb-3 group-hover:translate-x-1 transition-transform duration-300">
                {t(feature.title)}
              </h3>
